...
static const _Target_type_support_symbol_names_t _Target_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver_msgs, msg, Target)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, driver_msgs, msg, Target)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, driver_msgs, msg, Target)() {
  return &::driver_msgs::msg::rosidl_typesupport_c::Target_message_type_support_handle;
}
