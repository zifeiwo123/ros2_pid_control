...
#include "driver_msgs/msg/detail/target__rosidl_typesupport_fastrtps_c.h"
...
#include "driver_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_driver_msgs
...
using _Target__ros_msg_type = driver_msgs__msg__Target;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver_msgs
size_t get_serialized_size_driver_msgs__msg__Target(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Target__ros_msg_type * ros_message = static_cast<const _Target__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Target__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_driver_msgs__msg__Target(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_driver_msgs
size_t max_serialized_size_driver_msgs__msg__Target(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = driver_msgs__msg__Target;
    is_plain =
      (
...
static size_t _Target__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_driver_msgs__msg__Target(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, driver_msgs, msg, Target)() {
