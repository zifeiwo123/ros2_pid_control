...
static const _Target_type_support_symbol_names_t _Target_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, driver_msgs, msg, Target)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, driver_msgs, msg, Target)),
  }
};
...
get_message_type_support_handle<driver_msgs::msg::Target>()
{
  return &::driver_msgs::msg::rosidl_typesupport_cpp::Target_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, driver_msgs, msg, Target)() {
  return get_message_type_support_handle<driver_msgs::msg::Target>();
}
