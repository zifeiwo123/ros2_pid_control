...
class Metaclass_Target(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('driver_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'driver_msgs.msg.Target')
            logger.debug(
...
class Target(metaclass=Metaclass_Target):
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Vector3
        self.target = kwargs.get('target', Vector3())
    ...
    def target(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'target' field must be a sub message of type 'Vector3'"
        self._target = value
