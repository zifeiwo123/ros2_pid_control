...
bool driver_msgs__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("driver_msgs.msg._target.Target", full_classname_dest, 30) == 0);
  }
  driver_msgs__msg__Target * ros_message = _ros_message;
  {  // name
  ...
  {  // target
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->target)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * driver_msgs__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("driver_msgs.msg._target");
  ...
  {  // target
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->target);
    if (!field) {
      return NULL;
    }
    {
